...
class MemberRepositoryTest {
    ...
    void 이름과_최소_나이로_회원을_조회한다() {
        // when
        List<Member> result =
                memberRepository.findByUsernameContainingIgnoreCaseAndAgeGreaterThanEqual(
                        "민",
                        20
                );
    ...
    void 활성_회원을_페이징하여_조회한다() {
        ...
        // then
        assertThat(result.getContent()).hasSize(2); // TODO 7: 데이터 2개를 검증하세요.
    ...
    void JPQL로_활성_회원을_검색한다() {
        ...
        assertThat(result)
                ...
                .containsExactly(29,24); // TODO 9: 나이가 29, 24 순서인지 검증하세요.
    }
}